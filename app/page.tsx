...
const UI = {
  en: { title: 'AI News Digest', subtitle: 'Intelligence Feed', refresh: '↻ Refresh', loading: 'Loading…', fetching: 'Fetching from all sources…', topStories: 'Top stories · last 24h', allArticles: 'All articles', noResults: 'No articles match these filters.', search: 'Search articles…', allSources: 'All sources', updated: 'Updated', newArticles: 'new articles — click to load', newArticle: 'new article — click to load', read: 'Read ↗', watch: 'Watch ↗', readFull: 'Read article ↗', watchFull: 'Watch on YouTube ↗', grid: '⊞ Grid', list: '☰ List', dir: 'ltr' },
  zh: { title: 'AI 新闻摘要', subtitle: '智能资讯', refresh: '↻ 刷新', loading: '加载中…', fetching: '正在获取所有来源…', topStories: '热门新闻 · 最近24小时', allArticles: '全部文章', noResults: '没有符合条件的文章。', search: '搜索文章…', allSources: '所有来源', updated: '更新于', newArticles: '条新文章', newArticle: '条新文章', read: '阅读 ↗', watch: '观看 ↗', readFull: '阅读文章 ↗', watchFull: '在YouTube观看 ↗', grid: '⊞ 网格', list: '☰ 列表', dir: 'ltr' },
  ar: { title: 'ملخص أخبار الذكاء الاصطناعي', subtitle: 'تغذية المعلومات', refresh: '↻ تحديث', loading: 'جارٍ التحميل…', fetching: 'جارٍ جلب المصادر…', topStories: 'أبرز الأخبار · آخر 24 ساعة', allArticles: 'جميع المقالات', noResults: 'لا توجد مقالات.', search: 'البحث…', allSources: 'جميع المصادر', updated: 'تحديث', newArticles: 'مقالات جديدة', newArticle: 'مقالة جديدة', read: 'اقرأ ↗', watch: 'شاهد ↗', readFull: 'اقرأ المقالة ↗', watchFull: 'شاهد على يوتيوب ↗', grid: '⊞ شبكة', list: '☰ قائمة', dir: 'rtl' },
};
